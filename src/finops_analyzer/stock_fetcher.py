...
from .models import StockHolding, StockAnalysis, RiskLevel
...
class StockDataFetcher:
    ...
    def enrich_holding(self, holding: StockHolding) -> StockHolding:
        ...
        try:
            ...
            holding.fifty_two_week_high = Decimal(str(info.get("fiftyTwoWeekHigh", 0))) if info.get("fiftyTwoWeekHigh") else None
            holding.fifty_two_week_low = Decimal(str(info.get("fiftyTwoWeekLow", 0))) if info.get("fiftyTwoWeekLow") else None
